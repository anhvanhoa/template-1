                ...
                MonthCaption: ({ calendarMonth }) => {
                    return (
                        <div className='inline-flex gap-2'>
                            ...
                            >
                                <SelectTrigger className='w-fit gap-1 border-none p-0 focus:ring-0 shadow-none'>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {MONTHS.map((month) => (
                            ...
                            >
                                <SelectTrigger className='shadow-none focus:ring-0 w-fit gap-1 border-none p-0'>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    {YEARS.map((year) => (
